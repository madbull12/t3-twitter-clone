        ...
        />
          {selectedFile &&  (
            <div className="relative">
              ...
              <img src={preview} />
              <div onClick={()=>setSelectedFile(undefined)} className="cursor-pointer bg-[#00000083] rounded-full  w-8 h-8 text-white  text-xl  grid place-items-center absolute top-4 right-4">
                <RiCloseLine />
              </div>
            </div>
          ) }
